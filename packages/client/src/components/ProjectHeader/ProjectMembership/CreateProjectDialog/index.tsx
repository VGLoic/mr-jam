...
const CreateProjectDialog = ({
    ...
    return (
        ...
        >
            ...
            <DialogContent>
                <DialogContentText>
                    Who is the admin of this project?
                </DialogContentText>
                ...
                <Box display="flex" flexWrap="wrap" className={classes.additionalUsersContainer}>
                    {additionalUsers.map((wrappedUser) => (
                        <div key={wrappedUser.user.id} className={classes.userChip}>
                            ...
                            >
                                <Chip
                                    color="primary"
                                    label={`${wrappedUser.address.slice(0, 4)}...${wrappedUser.address.slice(-4)}`}
            ...
            <DialogActions>
                ...
                >
                    {transactionState.loading ? <CircularProgress size={20} /> : "Confirm"}
                </Button>
            </DialogActions>
        </Dialog>
    )
